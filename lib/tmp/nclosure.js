 ...
 * @private
 */
//var NCLOSUREBASE    = require('./nclosurebase'),
    //SETTINGSLOADER  = require('./settingsloader');
    //,nclosurebase_   = NCLOSUREBASE.nclosurebase;
...
goog.addSingletonGetter(nclosure);
goog.inherits(nclosure, nclosure.base);

/**
 * @private
 * @type {nclosure.settingsLoader}
 */
nclosure.settingsLoader_ = /** @type {nclosure.settingsLoader} */
 ...
 * @type {boolean}
 */
nclosure.initialised_ = false;


nclosure.prototype.setOptions = function (options) {

};

nclosure.prototype.getOption = function (optionName) {

};

nclosure.prototype.getOptions = function () {

};

nclosure.prototype.updateOptions = function (options) {
...
var inst_ = nclosure.getInstance();
exports.nclosure = goog.bind(inst_.updateOptions, inst_);
